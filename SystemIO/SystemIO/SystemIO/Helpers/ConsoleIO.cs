...
namespace SystemIO.Helpers
{
    public class ConsoleIO
    {
        ...
        public const string StudentLineFormat = "{0,-21} {1,-22} {2,-21}";

        public const string PickStudentLineFormat = "{0,2} {1,-18} {2,-18} {3, 7}";
        ...
        public static string GetRequiredStringFromUser(string prompt)
        {
            while (true)
            {
                ...
                {
                    Console.WriteLine("You must enter valid test.");
        ...
        public static int GetStudentIndexFormUser(string prompt, int count)
        {
            int output;
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    {
                        Console.WriteLine("Please enter a student by number between {0} and {1}", 1, count);
                        Console.WriteLine("Press any key to continue...");
                        Console.ReadKey();
                        continue;
                    }
